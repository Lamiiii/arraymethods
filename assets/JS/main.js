...
// function newPrice(order){
//     const{id,details}=order
//      const {quantity,unitPrice,discount}=details
//      const totalPrice=quantity*unitPrice-discount
//      return ` ${id} nomreli sifaris ucun: ${totalPrice}`
// }

// const otherAdress=orders.map((item)=>newPrice(item))
...
//     const { quantity, unitPrice,discount} = details;
//     const totalPrice = quantity * unitPrice-discount;
//     return `Sifariş ${id} üçün ümumi qiymət: ${totalPrice}`;
// }

// const updatedOrders = orders.map(item => newPrice(item));

// console.log(updatedOrders);


// function formatAdress(order){
//     const {street,city,country}=order.shipAddress
//     return `${street},${country},${city}`
// }

// const otherAdress=orders.map((item)=>formatAdress(item))

// console.log(otherAdress);


// const ratings = order.map(item => ({
//     vv:item.shipAddress.street,
//      nbv:item.shipAddress.country
//   }));
// console.log(ratings);


// const Data = order.reduce((acc, item) => acc + item.freight, 0);
// console.log(Data); 


// const newData=data.filter((item)=>item.shipAddress.country==="USA")
// console.log(newData);
...
// const newData=fruits.reduce((acc,item)=>{
...
// const maxValue=Object.entries(newData).sort((a,b)=>b[1]-a[1])[0][0]

// console.log(maxValue);



// const array=[1,4,6,57,45,32,5,54,27,37,18,-90,432];



// const newData=array.map((item)=>item**2)
// console.log(newData);
 

// const newData=array.filter((item)=>item%2===0)
// console.log(newData);


// const newData=array.reduce((acc,item)=>acc+item,0)

// console.log(newData);



// const newData=array.find((item)=>item>4)
// console.log(newData);


// const newData=array.some((item)=>item%2===0)
// console.log(newData);


// const newData=array.every((item)=>item>0)
// console.log(newData);


// const newData=array.filter((item)=>item>0 &&  item<=10)
// .map((item)=>item**2)
// .filter((item)=>item>20)
// console.log(newData);

// const arrays=[1,3,2,12,13,3,2];

// const newData=arrays.reduce((acc,item)=>{
//     acc+=item
//     if(acc>20){
//         return acc
//     }else{
...
// console.log(Full(arrays));




// const newData=arrays.map((item)=>item*2)
// .sort((a,b)=>b-a)[0]
...
// const newData=orders.map((item)=>item.shipName.toUpperCase())
// console.log(newData);


// const newData=orders.map((item)=>item.shipName.replace("Split","Lamiye"))
// console.log(newData);


// const newData=orders.map((item)=>item.shipName.includes("Split"))
// console.log(newData);


// const newData=orders.map((item)=>item.shipName.replace("Beer","Ale"))
// console.log(newData);



// const newData=orders.map((item)=>item.shipName.length)
// console.log(newData);


// const newData=orders.map(item=>item.shipName.split("   "))
// console.log(newData);
...
//  addBook(title,author,isavalible){
//     this.books.push({title,author,isavalible})
//  }
...
// const list= new library();
// list.addBook("title: Anna Kranina","author:Tolstoy",isavalible=true);
